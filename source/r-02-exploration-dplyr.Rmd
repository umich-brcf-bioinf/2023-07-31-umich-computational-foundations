...
>     arrange(median_POP)
> ```
> Try to write the code that would generate the following table, similar to the above, but for the GDP per continent instead of the population, and including the mean GDP in addition to the min, median, and max.
> 
